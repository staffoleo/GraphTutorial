...
namespace Orders.Services
{
  public interface ICustomerService
  {
    ...
    Task<IEnumerable<Customer>> GetCustomersAsync(int id);
  }
  ...
  public class CustomerService : ICustomerService
  {
    ...
    {
      return Task.FromResult(_customers.Single(x => x.Id == id));
    }

    public Task<IEnumerable<Customer>> GetCustomersAsync(int id)
    {
